...
export function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Card className="flex flex-col hover:border-primary/50 hover:bg-card/80 transition-all">
      <CardHeader>
        <CardTitle className="text-lg">
          <Link href={`/project/${project.id}/board`} className="hover:text-primary transition-colors">
            {project.name}
          </Link>
        </CardTitle>
